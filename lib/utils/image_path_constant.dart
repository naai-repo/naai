...
class ImagePathConstant {
  ...
  static final String splashLogo =
      UtilityFunctions.getImagePath(imageTitle: 'splash_logo.svg');
  static final String googleIcon =
      UtilityFunctions.getImagePath(imageTitle: 'google_icon.svg');
  static final String appleIcon =
      UtilityFunctions.getImagePath(imageTitle: 'apple_icon.svg');
  static final String backArrowIos =
      UtilityFunctions.getImagePath(imageTitle: 'back_arrow_ios.svg');
  static final String searchIcon =
      UtilityFunctions.getImagePath(imageTitle: 'search_icon.svg');
  static final String downArrow =
      UtilityFunctions.getImagePath(imageTitle: 'down_arrow.svg');
  static final String locationIcon =
      UtilityFunctions.getImagePath(imageTitle: 'location_icon.svg');
  static final String splashIcon =
  ...
  static final String scissorsIcon =
      UtilityFunctions.getImagePath(imageTitle: 'scissors_icon.svg');
}
